// Core Loader - Production Version
// Hardcoded for live servers only

(function() {
  'use strict';

  // PRODUCTION ONLY - Hardcoded API URL
  ...
  // Force the correct API base
  window.APP.API_BASE = 'https://api.eskisiniveryenisinial.com';
  window.GLOBAL_API_BASE = 'https://api.eskisiniveryenisinial.com';
  window.API_BASE = 'https://api.eskisiniveryenisinial.com';

  console.log('🚀 Production Core-loader: API_BASE hardcoded to:', window.APP.API_BASE);
